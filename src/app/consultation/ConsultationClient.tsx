    ...
    <div dir="rtl" className="min-h-screen bg-[#0a0a0a] text-white selection:bg-amber-500/30 overflow-hidden font-sans">
      ...
      <section className="py-24 px-6 lg:px-8 bg-[#111] border-t border-white/5 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {/* Testimonial 1 */}
            <motion.div variants={fadeIn} className="bg-[#1a1a1a] p-10 rounded-3xl border border-white/5 relative group hover:border-amber-500/30 transition-colors">
              ...
              <p className="text-zinc-300 text-lg leading-relaxed mb-8 relative z-10 italic">
                "كانت ساعة واحدة كفيلة بتغيير مسار خطتنا التسويقية بالكامل. الأستاذ جاسم وضع يده على الجرح وأعطانا حلولاً سريعة واضحة جداً. العائد من الاستشارة كان أضعاف تكلفتها!"
              </p>
              <div className="flex items-center gap-4 relative z-10">
                <div className="w-14 h-14 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center font-bold text-xl text-[#111] shadow-lg">ع</div>
                <div>
                  <h4 className="font-bold text-white text-lg">عبدالله المرزوقي</h4>
                  <p className="text-zinc-500">مؤسس متجر إلكتروني</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="bg-[#1a1a1a] p-10 rounded-3xl border border-white/5 relative group hover:border-amber-500/30 transition-colors">
              ...
              <p className="text-zinc-300 text-lg leading-relaxed mb-8 relative z-10 italic">
                "كنت تائهاً وسط الكثير من الاستراتيجيات ولا أعرف من أين أبدأ. الاستشارة رتبت أفكاري وأعطتني خارطة طريق واضحة جداً. أنصح بها وبشدة لأي صاحب مشروع يواجه تحديات."
              </p>
              <div className="flex items-center gap-4 relative z-10">
                <div className="w-14 h-14 bg-gradient-to-br from-zinc-700 to-zinc-900 border border-white/10 rounded-full flex items-center justify-center font-bold text-xl text-white shadow-lg">م</div>
                <div>
                  <h4 className="font-bold text-white text-lg">محمد العتيبي</h4>
                  <p className="text-zinc-500">صاحب وكالة تسويق</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="py-24 px-6 lg:px-8 relative z-10 overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-6 mt-6">ضمان القيمة الحقيقية 100%</h2>
          <p className="text-zinc-400 text-lg leading-relaxed max-w-2xl mx-auto">
            نحن نقدر وقتك واستثمارك. إذا لم تخرج من هذه الاستشارة بفائدة ملموسة وخطوات واضحة قابلة للتطبيق تحدث فرقاً في مشروعك، فنحن نلتزم باسترجاع قيمة الاستشارة بالكامل بدون أي أسئلة.
          </p>
        </motion.div>
      </section>
    </div>
