...
export default function ProblemSection() {
  return (
    <section id="problem-section" className="section-padding bg-surface-1 border-y border-brand-white/5" dir="rtl" aria-labelledby="problem-heading">
      <div className="max-w-5xl mx-auto text-center">
        <span className="text-brand-red text-xs font-bold uppercase tracking-widest mb-4 block">المشكلة الحقيقية</span>
        <h2 id="problem-heading" className="text-2xl md:text-4xl font-black text-white mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6" role="list">
          {[
            ...
            <div key={i} className="glass rounded-2xl p-6 text-center hover:border-brand-red/20 transition-all group" role="listitem">
