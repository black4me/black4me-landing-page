...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-black border-t border-brand-white/5 pt-16 pb-8 px-4" dir="rtl">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mt-3">بواسطة جاسم محمد (Jasim Mohammed)</p>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 py-6 border-t border-brand-white/5 mb-6">
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-500">
            <span className="font-mono font-bold text-gray-400">Stripe</span>
            <span>•</span>
            <span className="font-mono font-bold text-gray-400">PayPal</span>
          </div>
          <div className="flex items-center gap-1.5 text-xs text-gray-500">
